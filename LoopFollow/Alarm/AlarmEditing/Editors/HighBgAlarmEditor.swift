...
struct HighBgAlarmEditor: View {
    ...
    var body: some View {
        Group {
            InfoBanner(
                text: "Alerts when glucose stays above the limit you set below. Use Persistent if you want to ignore brief spikes."
            )
            ...
            AlarmStepperSection(
                ...
                footer: "How long glucose must remain above the threshold before the alarm actually fires. Set to 0 for an immediate alert.",
